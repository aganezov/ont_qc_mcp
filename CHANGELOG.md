...
### Changed
- Replace the bundled real sequencing examples with a small public HG002 ONT BAM/FASTQ and matched Clair3 VCF, with source attribution and checksums.
- Raise the AnyIO runtime minimum to 4.14.2 and lock development and CI environments to 4.15.1.
