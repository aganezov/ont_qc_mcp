...
### Fixed
- Cooperatively stop owned subprocess groups on request cancellation, interrupt retry waits and streaming stderr readers, attempt removal of the invocation's Docker container, and clean generated IGV artifacts on failure.
